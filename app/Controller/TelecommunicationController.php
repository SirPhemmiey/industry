<?php
class TelecommunicationController extends AppController{
   ...
   public function beforeFilter(){
        ...
        //$this->Session->write('industries_id', 1);
    }
  ...
  public function index(){ 
        ...
        $query = $this->Company->find('all', array(
            ...
            'conditions' => array('industries_id' => 1),
            'order' => array('Company.companies_name' => 'ASC')));
        $this->set(compact('query'));       
    }

    public function chooseTelecomms(){
        $this->layout = false;
        $getValue = $_POST['telecommsValue'];
       ...
       public function productEdit(){
        ...
        if(!is_null($this->request->query('productID'))){
            ...
            $specificPrimaryCat = $this->PrimaryCategory->find('all', array(
                ...
                'conditions' => array('PrimaryCategory.industries_id' => 1,
            ...
            $specificParentCat = $this->ParentCategory->find('all', array(
                ...
                'conditions' => array('ParentCategory.industries_id' => 1,
            ...
            $product_name = $this->Product->find('all', array(
             ...
             $specificCompany = $this->Company->find('all', array(
                ...
                'conditions' => array('Company.industries_id' => 1,
    ...
    public function addProducts(){
        ...
        $allPrimaryCat = $this->PrimaryCategory->find('all', array(
            'fields' => array('PrimaryCategory.primary_categories_name', 'PrimaryCategory.primary_categories_id'),
            'conditions' => array(
            'PrimaryCategory.industries_id' => 1,
        ...
        $allParentCat = $this->ParentCategory->find('all', array(
            'conditions' => array(
            'ParentCategory.industries_id' => 1,
        ...
        if($this->request->is('post')){
            ...
            if(!empty($this->data)){
                ...
                //     }
                // }
                 $this->request->data['Product']['products_image'] = $products_image;
                $condition = array(
      ...
      public function checkCompany(){
        ...
        if($this->request->is('post')){
            ...
            //this will query the table to get the company image
            $get_company = $this->Company->find('first', array(
                'fields' => array(
                    'Company.picture', 'Company.companies_id'),
                'conditions' => array(
                    'Company.companies_id' => $company_id)));
            echo $get_company['Company']['picture'];
        }
    }
