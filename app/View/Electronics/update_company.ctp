<div class="row">
    <div class="col-md-12">
        ...
        <!-- Parent Category -->
        <form action="<?php echo $this->webroot;?>electronics/updateCompany" method="post" enctype="multipart/form-data">
...
<script>
    $("#companies").on('change', function() {
        ...
        $.ajax({
            type : "POST",
            url : "<?php echo $this->webroot;?>electronics/chooseCompany",
            async : true,
