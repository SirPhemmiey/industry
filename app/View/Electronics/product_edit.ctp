...
<div class="row">
<div class="col-md-12">
<form action="<?php echo $this->webroot;?>electronics/productEdit" enctype="multipart/form-data" method="post" id="myForm">
...
<div class="col-md-10 col-md-offset-1">
    ...
    <b>Industry</b> : <span class="panel-title">ELECTRONICS</span> <br>
</div>
<?php }?>
...
$companyID = $products['Company']['companies_id'];?>
    <tr>
        ...
        <td id="<?php echo $products['Product']['products_id'];?>">
            <a href="<?php echo $this->webroot;?>electronics/productEdit?productID=<?php echo $productsId;?>">
                <?php echo ucwords($products['Product']['products_name']);?>
            </a>
        </td>
        <td>
           <a href="<?php echo $this->webroot;?>electronics/productEdit?ProductCompanyID=<?php echo $companyID;?>">
	...
	<table class="table table-bordered datatable">
							...
							<?php 
								...
								<tr>
									...
									<td id="<?php echo $products['Product']['products_id'];?>"><a href="<?php echo $this->webroot;?>electronics/productEdit?productID=<?php echo $productsId;?>"><?php echo ucwords($products['Product']['products_name']);?></a></td>
									<td><a href="<?php echo $this->webroot;?>electronics/productEdit?productCat=<?php echo $productsCat;?>"><?php echo $products['PrimaryCategory']['primary_categories_name'];?></a></td>
                                    <td><a href="<?php echo $this->webroot;?>electronics/productEdit?parentCat=<?php echo $parentCat;?>"><?php echo $products['ParentCategory']['parent_categories_name'];?></a></td>
...
<?php if(isset($parentProductCompID)){?>
    <table class="table table-bordered datatable">
                            ...
                            <?php 
                                ...
                                <tr>
                                    <td><?php echo $counter++;?></td>
                                    <td id="<?php echo $prod['Product']['products_id'];?>"><a href="<?php echo $this->webroot;?>electronics/productEdit?productID=<?php echo $productsId;?>"><?php echo ucwords($prod['Product']['products_name']);?></a></td>
                                    <td><a href="<?php echo $this->webroot;?>electronics/productEdit?productCat=<?php echo $productsCat;?>"><?php echo $prod['PrimaryCategory']['primary_categories_name'];?></a></td>
                                    <td><a href="<?php echo $this->webroot;?>electronics/productEdit?ProductCompanyID=<?php echo $productCompanyID;?>"><?php echo $prod['Company']['companies_name'];?></a></td>
...
swal({
    ...
    $(document).ajaxStop(function(){
        window.location = '<?php echo $this->webroot;?>electronics';
    });
