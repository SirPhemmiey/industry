<div class="row">
    <div class="col-md-12">
        ...
        <!-- Parent Category -->
        <form action="<?php echo $this->webroot;?>telecomAccessories/addCompany" method="post">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <a href="<?php echo $this->webroot;?>telecomAccessories/updateCompany" target="_blank"><button type="button" class="btn btn-primary">Update Company</button></a>
