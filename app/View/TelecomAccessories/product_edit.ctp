...
<div class="row">
<div class="col-md-12">
<form action="<?php echo $this->webroot;?>telecomAccessories/productEdit" enctype="multipart/form-data" method="post" id="myForm">
...
<div class="col-md-10 col-md-offset-1">
    ...
    <b>Industry</b> : <span class="panel-title">TELECOM ACCESSORIES</span> <br>
</div>
<?php }?>
...
<div class="col-md-10 col-md-offset-5">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
     <li role="presentation" > <a role="menuitem"  href="<?php echo $this->webroot;?>telecomAccessories/addProducts">Product</a> </li> 
     <li role="presentation"> <a role="menuitem"  href="<?php echo $this->webroot;?>telecomAccessories/addSubCategory">Sub Category</a> </li> 
     <li role="presentation"> <a role="menuitem"  href="<?php echo $this->webroot;?>telecomAccessories/addParentCategory"> Parent Category </a> </li>
     <li role="presentation"> <a role="menuitem"  href="<?php echo $this->webroot;?>telecomAccessories/addCompany"> Company </a> </li>  
 </ul> </div>
    </h4>

</div>
<div class="col-md-9">
      <a href="<?php echo $this->webroot;?>telecomAccessories/deleteProduct"><button type="button" class="btn btn-primary btn-sm">Delete Product</button></a>
</div>
</div>
</div>
...
$companyID = $products['Company']['companies_id'];?>
    <tr>
        ...
        <td id="<?php echo $products['Product']['products_id'];?>">
            <a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?productID=<?php echo $productsId;?>">
                <?php echo ucwords($products['Product']['products_name']);?>
            </a>
        </td>
        <td>
           <a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?ProductCompanyID=<?php echo $companyID;?>">
	...
	<table class="table table-bordered datatable">
							...
							<?php 
								...
								<tr>
									...
									<td id="<?php echo $products['Product']['products_id'];?>"><a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?productID=<?php echo $productsId;?>"><?php echo ucwords($products['Product']['products_name']);?></a></td>
									<td><a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?productCat=<?php echo $productsCat;?>"><?php echo $products['PrimaryCategory']['primary_categories_name'];?></a></td>
                                    <td><a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?parentCat=<?php echo $parentCat;?>"><?php echo $products['ParentCategory']['parent_categories_name'];?></a></td>
...
<?php if(isset($parentProductCompID)){?>
    <table class="table table-bordered datatable">
                            ...
                            <?php 
                                ...
                                <tr>
                                    <td><?php echo $counter++;?></td>
                                    <td id="<?php echo $prod['Product']['products_id'];?>"><a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?productID=<?php echo $productsId;?>"><?php echo ucwords($prod['Product']['products_name']);?></a></td>
                                    <td><a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?productCat=<?php echo $productsCat;?>"><?php echo $prod['PrimaryCategory']['primary_categories_name'];?></a></td>
                                    <td><a href="<?php echo $this->webroot;?>telecomAccessories/productEdit?ProductCompanyID=<?php echo $productCompanyID;?>"><?php echo $prod['Company']['companies_name'];?></a></td>
...
swal({
    ...
    $(document).ajaxStop(function(){
        window.location = '<?php echo $this->webroot;?>telecomAccessories';
    });
