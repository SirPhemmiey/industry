<div class="row">
     <div class="col-md-12">
        ...
        <!-- Basic layout-->
        <form action="<?php echo $this->webroot;?>banking/addSubCategory" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="multi-select-full">
                            <select name="data[PrimaryCategory][parent_categories_id]" class="multiselect-filtering" id="parentCat">
                               <option value="Please Category" class="option">Please select a Parent Category</option>
                       ...
                       <div class="form-group">
                        ...
                        <div class="multi-select-full">
                            <select name="data[PrimaryCategory][industries_id]" class="multiselect-filtering" id="industryCat">
                                <option value="Please Industry" class="option">Please select an Industry</option>
