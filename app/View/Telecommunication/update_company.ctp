<div class="row">
    <div class="col-md-12">
        ...
        <!-- Parent Category -->
        <form action="<?php echo $this->webroot;?>telecommunication/updateCompany" method="post" enctype="multipart/form-data">
...
<script>
      $("#companies").on('change', function() {
        ...
        $.ajax({
            type : "POST",
            url : "<?php echo $this->webroot;?>telecommunication/chooseCompany",
            async : true,
            ...
            success : function(response){
                ...
                $("img#img").attr('src', '<?php echo $this->webroot;?>company_pictures/'+response);
            },
