...
<div class="row">
<div class="col-md-12">
<form action="<?php echo $this->webroot;?>telecommunication/addProducts" enctype="multipart/form-data" method="post">
                ...
                <div class="col-md-10 col-md-offset-1">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label>Company:</label>
                                    <div class="multi-select-full">
                                        <select required name="data[Product][companies_id]" class="multiselect-filtering" id="company">
                                ...
                                <input type="hidden" name="data[Product][products_image]" id="picImage">
<!-- 
                                <div class="form-group">
...
$("#company").on('change', function(){
    ...
    $.ajax({
        type : "POST",
        url  :  "<?php echo $this->webroot;?>telecommunication/checkCompany",
        data : {c_ID : value},
